 ...
 */
  ...
  #define LCD_PINS_RS P0_16 //28
  #define LCD_PINS_ENABLE P0_18 //29
  #define LCD_PINS_D4 P0_15 //10
  #define LCD_PINS_D5 P0_17 //11
  #define LCD_PINS_D6 P1_00 //16
  #define LCD_PINS_D7 P1_22 //17
  #define BTN_EN1 -1
  #define BTN_EN2 -1
  #define BTN_ENC -1
  #define ADC_KEYPAD_PIN P1_30// 1
#elif HAS_SPI_LCD
